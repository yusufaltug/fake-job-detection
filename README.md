...
## Sunumda Kullanılacak En Önemli Grafikler

1. `reports/class_distribution.png`: Veri seti dengesizliğini gösterir.
2. `reports/missing_values_top.png`: Eksik değerleri gösterir.
3. `reports/model_comparison.png`: Modelleri karşılaştırır.
4. `reports/confusion_matrix.png`: Doğru/yanlış tahminleri gösterir.
5. `reports/precision_recall_curve.png`: Dengesiz veri için model başarısını gösterir.
6. `reports/feature_importance.png`: Modelin sahte ilan kararında kullandığı ifadeleri gösterir.
